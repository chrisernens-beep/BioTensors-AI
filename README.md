...
> **Status:** early research (`v0.1`). The portable prototype uses ~1,100 neurons; larger-scale training runs on a separate workstation.
...
Command.py                # Experimental training UI (WIP)
old/                      # Earlier iterations
```
...
Christophe — pharmacist & independent developer (Belgium).  
Feedback and collaboration welcome via GitHub Issues.
